...
class XueHuaPinyin {
  ...
  static Future<void> initialize() async {
    try {
      ...
      log(e.toString(), error: e, stackTrace: s, name: "XueHuaPinyin.initialize");
    }
  }
  ...
  static List<String> getFirstLetters({required List<String> texts, String? digitFallback}) =>
  ...
  static List<String> toLazyPinyin({required String text, required PinyinArgs args}) =>
      pinyin_api.toLazyPinyin(text: text, args: args);

  /// Converts Chinese text to pinyin with optional heteronym support.
  static List<List<String>> toPinyin({required String text, required PinyinArgs args}) =>
